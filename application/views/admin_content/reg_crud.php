<div  id="main"></div><br/><br/><br/><br/>
<div class="col-md-8">
	<div class="messages"></div>
	
	<button class="btn btn-default pull pull-right" data-toggle="modal" data-target="#addRestaurant" onclick="addRestaurant()">Add Restaurant</button>
	<br/><br/>
	
	<table class="table table-bordered" id="manageRestaurantTable">
		<thead>
			<tr>
...
<!-- Add Modal -->
<div class="modal fade" id="addRestaurant" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="padding-top: 30px;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <?php echo form_open_multipart('restaurant_control/add_restaurant', 'id="createForm"'); ?>
...
<!-- Edit Modal -->
<div class="modal fade" id="editRestaurant" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top: 30px;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
	  ...
	  <?php echo form_open_multipart('restaurant_control/edit_restaurant', 'id="editForm"'); ?>
      <div class="modal-body">
        <div class="form-group">
		  <label for="name">Restaurant Name:</label>
...
<!-- delete Modal -->
<div class="modal fade" id="deleteRestaurant" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-top: 30px;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" id="deleteRestaurantBtn" class="btn btn-default">Delete</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript" language="javascript">
	...
	$(document).ready( function() {
		manageDataTable = $('#manageRestaurantTable').DataTable({
			'ajax': '<?php echo base_url();?>restaurant_control/fetch_restaurant_data',
			'orders': []
		});
	});
			...
			$.ajax({
				...
				success: function(data) {
					if(response.success === true) {
						...
						$("$addRestaurant").modal('hide'); // hide the model
	...
	function editRestaurant(id = null) 
	{
		if(id) {
			...
			$.ajax({
				url: "<?php echo base_url();?>restaurant_control/get_selected_restaurant/" + id,
				type: 'post',
				dataType: 'json',
				success:function(response) {
					...
					$("#txtId").val(response.RestaurantId);				
	...
	function deleteRestaurant(id = null) 
	{
		if(id) {
			$("#deleteRestaurantBtn").unbind('click').bind('click', function() {
				$.ajax({
					url: '<?php echo base_url();?>restaurant_control/delete_restaurant' + '/' + id,
					type: 'post',				
					dataType: 'json',
					success:function(response) {
						if(response.success === true) {
